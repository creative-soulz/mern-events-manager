...
<Route path="/home" element={<Home/>}/>
 ...
 <Route path="/createparticipant" element={<CreateParticipant/>} />
      ...
      <Route path="/stdrep" element={<StdRepRoute/>}>
        <Route path="createparticipant" element={<CreateParticipant/>}/>
        <Route
          path="participants/department/:departmentId/"
          element={<ParticipantsForStdRep />}
        />
        <Route
          path="participants/department/"
          element={<ParticipantsByDepartmentStdRep />}
        />
      </Route>
      {/* faculty routes */}
      <Route path="/faculty" element={<FacultyRoute/>}>
        ...
        <Route
          path="participants/department/:departmentId/"
          element={<ParticipantsForFaculty />}
        />
        <Route
          path="participants/department/"
          element={<ParticipantsByDepartmentFaculty />}
        />
      </Route>
      {/* *admin routes */}
     ...
     <Route path="userlist/register" element={<Register/>} />
        ...
        <Route
          path="participants/events/:eventId/participants"
          element={<ParticipantsByEventId />}
        />
         <Route
          path="participants/department/:departmentId/"
          element={<ParticipantsForAdmin />}
        />
        <Route
          path="participants/department/"
          element={<ParticipantsByDepartment />}
        />
