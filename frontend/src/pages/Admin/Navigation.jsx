          ...
          <List>
            ...
            >
              <ListItem className="p-0" selected={open === 1}>
                ...
                >
                  <ListItemPrefix>
                    <ComputerDesktopIcon color="white" className="h-5 w-5" />
                  </ListItemPrefix>
              ...
              <AccordionBody className="py-1">
                <List className=" text-white p-0">
                  <ListItem>
                    <ListItemPrefix>
                      <ChevronRightIcon   strokeWidth={3} className="h-3 w-5 " />
                    </ListItemPrefix>
                    <NavLink to="/admin/userlist/register">
                  ...
                  <ListItem>
                    ...
                    <Link to="/admin/participants/events">
                    Manage Winners</Link>
                  </ListItem>
                </List>
              </AccordionBody>
            ...
            >
              ...
              <AccordionBody className="py-1">
                ...
                <ListItem>
                    ...
                    <Link to="/admin/createparticipant">
                  ...
                  <ListItem>
                    ...
                    <Link to="/admin/participants/department">
